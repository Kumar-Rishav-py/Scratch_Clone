...
function MidArea({ area_list, add_list, event_values }) {
  ...
  const handleClick = (arr, id) => {
    console.log(area_list.midAreaLists[0]);
                ...
                <Droppable droppableId={l.id} type="COMPONENTS">
                  {(provided) => {
                    return (
                      ...
                      >
                        <div className="runButton absolute text-center mx-auto ">
                          <div
                            className="cursor-pointer h-full flex justify-center items-center"
                            onClick={() => handleClick(l.comps, l.id)}
                          >
                            <svg viewBox="0 0 26 26">
                              <polygon fill="#45993d" class="play-btn__svg" points="9.33 6.69 9.33 19.39 19.3 13.04 9.33 6.69" />
                              <path fill="#45993d" class="play-btn__svg" d="M26,13A13,13,0,1,1,13,0,13,13,0,0,1,26,13ZM13,2.18A10.89,10.89,0,1,0,23.84,13.06,10.89,10.89,0,0,0,13,2.18Z" />
                            </svg>
                          </div>
                        </div>
