...
import GotoY from "./motion/GotoY";
import GotoX from "./motion/GotoX";
import PointDirection from "./motion/PointDirection"
import RandomGoto from "./motion/RandomGoto";
...
import SetSize from "./looks/SetSize";
...
export const getComponent = (key, id) => {
  switch (key) {
    ...
    case "GOTOY":
      return <GotoY comp_id={id} />;
    
    case "GOTOX":
      return <GotoX comp_id={id} />;
    
    case "RANDOMGOTO":
      return <RandomGoto comp_id={id} />;
